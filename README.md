...
本项目由作者利用业余时间独立构思、设计并持续开发，旨在将日常学习中积累的前后端开发、数据库设计、AI 工作流编排、第三方平台接入及权限控制能力，落实为一套具备完整业务闭环、可以实际运行和演示的产品级 MVP。
仓库完整保留了从需求分析、系统架构、功能实现到安全脱敏和公开发布的工程过程，可作为作者实践全栈开发能力、独立解决问题能力与持续迭代能力的实践证明。
